                                ...
                                MaterialPageRoute(
                                  builder: (context) => EditCategoryScreen(
                                    ...
                                    onCategoryUpdated: (updatedCategory) {
                                      setState(() {
                                        widget.categoryList.updateCategory(index, updatedCategory);
                                      });
                                    },
                                  ),
                                ),
                              ...
                              showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Все записи в финансовом журнале с этой категорией будут удалены. Вы уверены, что хотите удалить категорию "${category.name}"?'),
                                    actions: [
                                      TextButton(
                                        onPressed: () {
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          await widget.categoryList.deleteCategory(index, entryList);
                                          setState(() {});
